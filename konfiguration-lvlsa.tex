...
% Gliederungsname
\newcommand{\gliederunglang}{Landesverband Sachsen-Anhalt}
\newcommand{\gliederungkurz}{LV LSA}

% Gliederungsanschrift
\newcommand{\gliederungstrasse}{Postfach LSA}
\newcommand{\gliederungort}{00000 LSADorf}

% 1.Vorsitz + Schatzmeisterei + Kontakt Email Adresse
\newcommand{\gliederungeinsvor}{Aye}
\newcommand{\gliederungschatzi}{Zig}
\newcommand{\gliederungkontakt}{schatzmeister@piratenpartei-lsa.de}

% Ort und Datum der Ausstellung der Bescheinigung
\newcommand{\bescheinigungort}{Zigdorf}
...
% Unterschrift gemäß EStR R 10b.1 Absatz 4 sowie ein Hinweistext eingedruckt. 
...
% \unterschriftsteuernummer müssen korrekt angegeben sein.
\newcommand{\unterschrift}{0}
\newcommand{\unterschriftdatummeldung}{dd.mm.201x}
\newcommand{\unterschriftfinanzamt}{ORT-DES-FINANZAMTES}
\newcommand{\unterschriftsteuernummer}{nnn/5xxx/nnnn}
